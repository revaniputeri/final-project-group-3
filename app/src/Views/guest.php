            ...
            <div class="col-md-6 grid-margin stretch-card px-2 pr-5">
                <div class="card shadow h-100">
                    <div class="card-body d-flex flex-column p-3">
                        ...
                        <div class="chart-container flex-grow-1" style="position: relative; height: 100%; width: 100%;">
                            <canvas id="lineChart" class="chart-canvas" style="height: 800px !important; width: 100% !important;"></canvas>
                        </div>
                    </div>
                </div>
            </div>
