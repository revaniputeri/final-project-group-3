                ...
                <div class="col-10">
                    ...
                    <div class="profile-header"
                        ...
                        <i class="fas fa-edit"
                            style="position: absolute; 
                                ...
                                padding: 8px; 
                                border-radius: 50%;"
                            data-bs-toggle="modal" data-bs-target="#changeProfileBackgroundModal"></i>
                        ...
                        <div style="position: relative; 
                            ...
                            <i class="fas fa-camera"
                                style="position: absolute; 
                                    ...
                                    padding: 5px; 
                                    border-radius: 50%;"
                                data-bs-toggle="modal" data-bs-target="#changeProfilePictureModal"></i>
                        </div>
                        <!-- Nama dan NIM -->
                    ...
                    <div class="profile-content" style="padding: 20px;">
                        ...
                        <div class="row text-center mb-4">
                            <div class="col-6">
                                <div
                                    style="background: linear-gradient(to right, #c5cae9, #ede7f6); 
                                        padding: 15px; 
                                        border-radius: 15px; 
                                        font-weight: bold;">
            ...
            <form method="POST" action="/dashboard/update-profile-image" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="newProfileImage" name="profile_image" required>
                    </div>
                </div>
...
<div class="modal fade" id="changeProfileBackgroundModal" tabindex="-1" aria-labelledby="changeProfileBackgroundLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form method="POST" action="/dashboard/update-profile-background" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="newProfileBackground" name="profile_background" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
