                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-description mb-4">
                                Edit detail prestasi Anda. Tanda <span class="text-danger">*</span> menandakan wajib
                                diisi.
                            </p>

                            <form class="forms-sample" method="POST"
                                action="/dashboard/achievement/edit/<?= $achievement['Id'] ?>"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-control" id="competitionType"
                                                        name="competitionType" required>
                                                        <option value="">Pilih Jenis Kompetisi</option>
                                                        <option value="Sains"
                                                            <?= $achievement['CompetitionType'] == 'Sains' ? 'selected' : '' ?>>Sains</option>
                                                        <option value="Seni" <?= $achievement['CompetitionType'] == 'Seni' ? 'selected' : '' ?>>Seni</option>
                                                        <option value="Olahraga"
                                                            <?= $achievement['CompetitionType'] == 'Olahraga' ? 'selected' : '' ?>>Olahraga</option>
                                                        <option value="Lain-Lain"
                                                            <?= $achievement['CompetitionType'] == 'Lain-Lain' ? 'selected' : '' ?>>Lain-Lain</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    <label class="form-label" for="competitionLevel">Tingkat Kompetisi
                                                        <span class="text-danger">*</span></label>
                                                    <select class="form-control" id="competitionLevel"
                                                        name="competitionLevel" required>
                                                        <option value="">Pilih Tingkat Kompetisi</option>
                                                        <?php foreach ($competitionLevels as $id => $level): ?>
                                                            <option value="<?= $id ?>"
                                                                <?= $achievement['CompetitionLevel'] == $id ? 'selected' : '' ?>><?= $level['name'] ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    <label class="form-label" for="competitionRank">Peringkat Kompetisi
                                                        <span class="text-danger">*</span></label>
                                                    <select class="form-control" id="competitionRank"
                                                        name="competitionRank" required>
                                                        <option value="">Pilih Peringkat Kompetisi</option>
                                                        <?php foreach ($competitionRanks as $id => $rank): ?>
                                                            <option value="<?= $id ?>"
                                                                <?= $achievement['CompetitionRank'] == $id ? 'selected' : '' ?>><?= $rank['name'] ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card shadow-sm mb-4">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="numberOfStudentsEdit"
                                        ...
                                        <div class="card shadow-sm mb-4">
                                            <div class="card-body">
                                                ...
                                                <div class="alert alert-info">
                                                    <small>Format file yang diizinkan: PDF, JPEG, PNG (Maks 5MB).
                                                        Biarkan kosong jika tidak ingin mengubah file.</small>
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="custom-file flex-grow-1">
                                                            <input type="file" class="custom-file-input" id="letterFile"
                                                                name="letterFile" accept=".pdf,.jpeg,.jpg,.png">
                                                            <label class="custom-file-label" for="letterFile">Pilih
                                                                file</label>
                                                        </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="custom-file flex-grow-1">
                                                            ...
                                                            <label class="custom-file-label" for="certificateFile">Pilih
                                                                file</label>
                                                        </div>
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="custom-file flex-grow-1">
                                                            ...
                                                            <label class="custom-file-label"
                                                                for="documentationFile">Pilih file</label>
                                                        </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="custom-file flex-grow-1">
                                                            <input type="file" class="custom-file-input" id="posterFile"
                                                                name="posterFile" accept=".pdf,.jpeg,.jpg,.png">
                                                            <label class="custom-file-label" for="posterFile">Pilih
                                                                file</label>
                                                        </div>
                                                            ...
                                                            foreach ($supervisors as $index => $supervisor):
                                                                ...
                                                                <div class="input-group mb-2">
                                                                    <select class="form-control dosen-pembimbing"
                                                                        ...
                                                                        <?php foreach ($lecturers as $lecturer): ?>
                                                                            <option value="<?= $lecturer['Id'] ?>"
                                                                                <?= $supervisor['Id'] == $lecturer['Id'] ? 'selected' : '' ?>><?= $lecturer['FullName'] ?></option>
                                                                        <?php endforeach; ?>
                                                                    </select>
                                                                    <div class="input-group-append">
                                                                        <?php if ($index > 0): ?>
                                                                            <button type="button" class="btn btn-danger"
                                                                                onclick="achievementForm.removeSupervisor(this)">
                                                    ...
                                                    <div id="teamMemberContainer">
                                                        ...
                                                        if (empty($teamLeaders) && empty($teamMembers) && empty($teamMembersPersonal)):
                                                            ...
                                                            <div class="input-group mb-2">
                                                                ...
                                                                <select class="form-control anggota-tim-peran"
                                                                    name="teamMemberRoles[]" required>
                                                                ...
                                                                <div class="input-group mb-2">
                                                                    <select class="form-control anggota-tim"
                                                                        ...
                                                                        <?php foreach ($students as $student): ?>
                                                                            ...
                                                                            ?>
                                                                            <option value="<?= $student['Id'] ?>" <?= $isSelected ? 'selected' : '' ?>><?= $student['FullName'] ?>
                                                                            </option>
                                                                        <?php endforeach; ?>
                                                                    </select>
                                                                    <select class="form-control anggota-tim-peran"
                                                                        ...
                                                                        <option value="Anggota"
                                                                            <?= $member['AchievementRole'] == '3' ? 'selected' : '' ?>>Anggota</option>
                                                                        <option value="Personal"
                                                                            <?= $member['AchievementRole'] == '4' ? 'selected' : '' ?>>Personal</option>
                                                                    </select>
                                                                    <div class="input-group-append">
                                                                        <?php if ($index > 0): ?>
                                                                            <button type="button" class="btn btn-danger"
                                                                                onclick="achievementForm.removeTeamMember(this)">
                                                                                <i class="fas fa-minus">-</i>
                                                                            </button>
                                                                        <?php endif; ?>
                                                                        <button type="button" class="btn btn-success"
