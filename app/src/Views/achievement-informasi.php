                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-justify">
                            Prestasi mahasiswa adalah penghargaan atau pencapaian yang diraih oleh mahasiswa dalam berbagai bidang, 
                            baik akademik maupun non-akademik, seperti kompetisi ilmiah, olahraga, seni, teknologi, hingga kegiatan 
                            sosial. Prestasi ini menjadi bukti nyata dari kemampuan, dedikasi, dan kreativitas mahasiswa dalam 
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>
                            Setiap poin yang dikumpulkan dapat digunakan untuk mendapatkan penghargaan atau diakui sebagai kontribusi 
        ...
        <div class="row pt-5">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <ol>
                            <li>Isi formulir pengajuan prestasi melalui sistem dengan mengeklik <strong>Tambahkan Prestasi</strong>.</li>
