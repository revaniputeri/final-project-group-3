...
class Student
{
    ...
    private const STORAGE_BASE_PATH = _DIR_ . '/../../../app/public/storage';
    ...
    {
        $stmt = $db->prepare("SELECT * FROM user WHERE fullName = ?");
     ...
     */
    public static function getStudentByUsername(PDO $db, int $username)
    {
